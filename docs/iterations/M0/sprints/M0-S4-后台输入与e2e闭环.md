...
- Dev A → `../reports/M0-S4-DevA-任务完成报告.md`
- Dev B → `../reports/M0-S4-DevB-任务完成报告.md`
- QA → `../reports/M0-S4-QA-任务完成报告.md`(含集成记录/用例矩阵/覆盖率/DEF/资产/结论)

三份齐备并全部进入 iter/m0 后,架构师才启动集中审查。

## 审核记录(架构师填写)

(结论与整改项见 `../reports/M0-S4-架构师审核报告.md`;通过后由架构师签发下一轮放行指令;本 Sprint 通过后还需迭代七项门禁与用户真机验证方可合入 main)
